...
(13, 'Chevrolet', 'Silverado', 2022, '0.00', 'USD', 'Camioneta', 'Automática', 'Gasolina', 'https://via.placeholder.com/400x250?text=Jeep+Wrangler', 'Usado', 'Negro', 'Gris', '0 km', '4', '4WD', 'Buenos Aires del Mirador', NULL, 'Aire acondicionado\nAlarma\nAirbags\nAirbag de pasajero\nAirbags laterales\nAirbags traseros\nFrenos ABS\nCruise control\nNavegación\nCámara de reversa\nSensor de parqueo\nBluetooth\nApple CarPlay\nAndroid Auto\nAsientos de cuero\nAsientos eléctricos\nVentanas automáticas\nSeguros eléctricos\nRetrovisores eléctricos\nGuía hidráulico\nGuía multifunción\nLlave inteligente\nFull Power\nFaros LED\nÚnico dueño\nPintura de fábrica\nAros de fábrica', NULL, 'El documento no especifica el precio de este vehículo.'),
