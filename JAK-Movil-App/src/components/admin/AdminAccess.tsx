...
export interface AdminUser { id: number; nombre: string; email: string; rol: 'admin' | 'empleado'; debe_cambiar_contrasena?: boolean | number; foto_url?: string | null; }
...
interface EmployeeProfile { id: number; nombre: string; email: string; rol: string; foto_url?: string | null; created_at: string; }
